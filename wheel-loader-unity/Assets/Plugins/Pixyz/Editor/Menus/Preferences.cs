...
namespace Pixyz.Editor {
    ...
    public static class Preferences {
        ...
        public static bool UXImprovementStats {
            ...
            set { PlayerPrefs.SetInt("Pixyz_UXImprovementStats", value ? 1 : 0); }
        }
        ...
        public static bool IncludeForRuntimeWindows {
            get { return EditorPrefs.GetBool("Pixyz_IncludeForRuntimeWindows", NativeInterface.IsTokenValid("UnityRuntime")); }
