...
{
    public class ContinuousServoMotorLogic : PreLogicComponent
    {
#pragma warning disable 0414
        [SerializeField] [Obfuscation] private int toolbarTab;
#pragma warning restore 0414

        public ContinuousServoMotor ServoMotor;
            ...
            DateTime _simStart)
        {
            ...
            {
                Debug.LogWarning("No " + typeof(ContinuousServoMotor).Name + " has been assigned.");
            }
        }
